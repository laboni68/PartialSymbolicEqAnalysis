...
(assert
 ...
 (let (($x274 (= (_ bv4294967101 32) return)))
 ...
 (let (($x271 (= (_ bv4294967086 32) return)))
 ...
 (let (($x268 (= (_ bv4294967071 32) return)))
 ...
 (let (($x261 (= return ?x186)))
 (let (($x262 (and $x45 $x41 $x261)))
 (let (($x266 (or $x262 $x264 $x265)))
 (let (($x278 (not $x266)))
 (let (($x280 (and $x278 $x279)))
 (let (($x277 (and $x266 $x276)))
 (let (($x281 (or $x277 $x280)))
 (not $x281))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
